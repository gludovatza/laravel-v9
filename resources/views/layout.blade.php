...
<body>
    ...
    <nav>
        ...
        <ul id="menu">
            ...
            <li><a class="{{ Request::path() === '/' ? 'active' : '' }}"
                    href="{{ route('homepage') }}">Kezdőoldal</a></li>
            <li><a class="{{ Request::path() === 'contact' ? 'active' : '' }}"
                    href="/contact">Kapcsolat</a></li>
            <li><a class="{{ Request::path() === 'flights' ? 'active' : '' }}"
                    href="/flights">Repülőjáratok</a></li>
            <li><a class="{{ Request::path() === 'airlines' ? 'active' : '' }}"
                    href="{{ route('airlines.index') }}">Légitársaságok</a></li>
            <li><a class="{{ Request::path() === 'cities' ? 'active' : '' }}"
                    href="/cities">Városok</a></li>
            <li><a class="{{ Request::path() === 'passengers' ? 'active' : '' }}"
                    href="/passengers">Utasok</a></li>
            <li><a class="{{ Request::path() === 'luggage' ? 'active' : '' }}"
                    href="/luggage">Poggyászok</a></li>
